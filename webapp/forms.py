...
class DotplotForm(forms.Form):
    sequence1 = forms.CharField(label = "Sequenz 1", max_length=200,  widget=forms.Textarea(attrs={"class": "textarea-input"}))
    sequence2 = forms.CharField(label = "Sequenz 2", max_length=200,  widget=forms.Textarea(attrs={"class": "textarea-input"}))
...
class OverlapForm(forms.Form):
    ...
    match = forms.IntegerField(label='Match', min_value=-1000, max_value=1000, initial=-1, widget=forms.NumberInput(attrs={'size': '10'}))
    mismatch = forms.IntegerField(label='Mismatch', min_value=-1000, max_value=1000, initial=1, widget=forms.NumberInput(attrs={'size': '10'}))
    gap_penalty = forms.IntegerField(label='Gap-Score', min_value=-1000, max_value=1000, initial=1, widget=forms.NumberInput(attrs={'size': '10'}))
...
class NeedlemanWunschForm(forms.Form):
    sequence1 = forms.CharField(label='Sequenz 1', widget=forms.Textarea(attrs={"class": "textarea-input"}))
    sequence2 = forms.CharField(label='Sequenz 2',  widget=forms.Textarea(attrs={"class": "textarea-input"}))
    match = forms.IntegerField(label='Match', min_value=-1000, max_value=1000, initial=0, widget=forms.NumberInput(attrs={'size': '10'}))
    mismatch = forms.IntegerField(label='Mismatch', min_value=-1000, max_value=1000, initial=1, widget=forms.NumberInput(attrs={'size': '10'}))
    gap_penalty = forms.IntegerField(label='Gap-Score', min_value=-1000, max_value=1000, initial=1, widget=forms.NumberInput(attrs={'size': '10'}))
    choices = [('distance', 'Distanz'), ('similarity', 'Ähnlichkeit')]
    optimization_field = forms.ChoiceField(widget=forms.RadioSelect, choices=choices, initial='distance', label='Optimieren nach:')
...
class GlocalAlignmentForm(forms.Form):
    ...
    mismatch = forms.IntegerField(label='Mismatch', min_value=-1000, max_value=1000, initial=1, widget=forms.NumberInput(attrs={'size': '10'}))
    gap_penalty = forms.IntegerField(label='Gap-Score', min_value=-1000, max_value=1000, initial=1,widget=forms.NumberInput(attrs={'size': '10'}))
    threshold = forms.IntegerField(label='Schwellenwert', min_value=-1000, max_value=1000, initial=1, widget=forms.NumberInput(attrs={'size': '10'}))
    choices = [('distance', 'Distanz'), ('similarity', 'Ähnlichkeit')] 
    optimization_field = forms.ChoiceField(widget=forms.RadioSelect, choices=choices, initial='distance', label='Optimieren nach:')
